...
//get the desired splat color and get the player's mouse input to lay down the splats daddy o
public class SplatMakerDog : MonoBehaviour {
	...
	void Start () {
	_emitter = transform.Find("rearPivot");
	}
	...
	void Update () {
		...
		if( Input.GetKeyDown (KeyCode.Alpha4) ){
            ...
            if (Input.GetKey (KeyCode.Space)) {
                ...
                if (Physics.Raycast(_emitter.position, Vector3.down, out detectColorHit, 100))
                {
