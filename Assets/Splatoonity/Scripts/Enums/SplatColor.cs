...
{
    public static Vector4 CYAN = new Vector4(0, 1, 1, 1); //#00FFFF
    public static Vector4 INDIGO = new Vector4(75f/255f, 0, 130f/255f, 1); //#4B0082
    public static Vector4 MAGENTA = new Vector4(1, 0, 1, 1); //#FF00FF
